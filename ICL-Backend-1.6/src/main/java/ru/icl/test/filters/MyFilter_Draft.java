...
public class MyFilter_Draft implements Filter {

    private FilterConfig filterConfig = null;
    
    private boolean active = false;
    
    public MyFilter_Draft() {
    }    
...
//            }
            ...
            Logger.getLogger(MyFilter_Draft.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }                               
